            ...
            <li class="nav-item active">
                ...
                <div id="collapseAccounts" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded"> 
                        ...
                        <a class="collapse-item active" href="AdminDashboardAdminAccounts.php"><i class="fas fa-fw fa-user"></i> Admin Accounts</a>  
                        <div class="collapse-divider"></div> 
                    </div>
                </div>
            </li> 
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid"> 
                    <!-- Page Heading --> 
                    <h1 class="h3 text-gray-800 mb-4">Admin Account Lists</h1> 
                    <!-- Content Row -->
                    <div class="row pl-1 pr-1"> 
                        <div class="col col-lg-12">
                        <table id="adminTable" class="table table-success shadow-lg hover" style="width:100%">
                            ...
                            <tbody class="text-center">
                                <?php
                                    $sql = "SELECT `ID`, `username`, `password`, `fullname` FROM `admin_accounts`";
