                            ...
                            if($result-> num_rows > 0) {
                                while ($row = $result -> fetch_assoc()) {
                                    echo "<tr>
                                            ...
                                            <td>
                                                <button type=\"button\" class=\"btn btn-primary btn-sm edit-ip-btn\" data-toggle=\"modal\" data-target=\"#editIpModal\" data-Ip-id=\"".$row["ID"]."\" data-ip-name=\"".$row["ip_address"]."\">
                    ...
                    <form id="editIpForm" action="ipeditsave.php" method="post">
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_ip_name" id="edit_ip_name" class="form-control" required>
